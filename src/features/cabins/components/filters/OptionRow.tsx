...
/** یک سطر انتخاب داخل پنل فیلتر (رادیویی/چندگزینه‌ای) */
export default function OptionRow({
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-3 rounded-2xl border px-4 py-3 text-start transition-all duration-200 active:scale-[0.99] ${
        selected
